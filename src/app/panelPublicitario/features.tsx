      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 text-3xl font-black text-white">
              Trabajar con datos no tiene por qué ser difícil
            </h2>
            <p className="text-xl text-gray-400">
              Nuestro principio rector es ayudar a los desarrolladores a
              resolver sus desafíos relacionados con datos.
            </p>
          </div>
